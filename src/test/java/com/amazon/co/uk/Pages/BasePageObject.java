...
public class BasePageObject {
    ...
    public void switchToNewWindowsWithTitle(String expectedTitle){
    ...
    public void hoverOverElement(By elementLocator) {
        ...
        Actions action = new Actions(driver);
        action.moveToElement(find(elementLocator)).build().perform();
    }
    ...
    public static Iterator<Object[]> csvReader(Method method) {
        ...
        String pathname = System.getProperty("user.dir") +
                "//src//main//resources//Data Provider//dataNegativeTestProvider.csv";
    ...
    public void selectOption(int n, By locator){
